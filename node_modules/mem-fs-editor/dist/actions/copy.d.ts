...
type CopyOptions<TransformData = unknown, TransformOptions = unknown> = CopySingleOptions<TransformData, TransformOptions> & {
    noGlob?: boolean;
    /**
...
export declare function copySingle<const TransformData = unknown, const TransformOptions = unknown>(editor: MemFsEditor, from: string, to: string, options?: CopySingleOptions<TransformData, TransformOptions>): void;
export declare function copy<const TransformData = unknown, const TransformOptions = unknown>(this: MemFsEditor, from: string | string[], to: string, options?: CopyOptions<TransformData, TransformOptions>): void;
export {};
