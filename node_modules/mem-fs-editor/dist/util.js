...
export function getCommonPath(filePath) {
...
export function globify(inputFilePath) {
...
export function isBinary(filePath, newFileContents) {
...
export function resolveFromPaths({ from, fromBasePath, }) {
...
export function resolveGlobOptions({ noGlob, hasDynamicPattern, }) {
