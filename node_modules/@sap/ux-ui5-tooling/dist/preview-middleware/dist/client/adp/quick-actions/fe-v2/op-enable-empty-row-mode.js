...
sap.ui.define(["../table-quick-action-base", "../control-types", "./utils", "../../../utils/version", "../../../utils/core", "../common/utils", "./create-table-custom-column"], function (___table_quick_action_basejs, ___control_typesjs, ___utilsjs, _____utils_versionjs, _____utils_corejs, ___common_utilsjs, ___create_table_custom_columnjs) {
  "use strict";
  ...
  const areManifestChangesSupported = ___utilsjs["areManifestChangesSupported"];
  const prepareManifestChange = ___utilsjs["prepareManifestChange"];
  ...
  const preprocessActionExecution = ___create_table_custom_columnjs["preprocessActionExecution"];
