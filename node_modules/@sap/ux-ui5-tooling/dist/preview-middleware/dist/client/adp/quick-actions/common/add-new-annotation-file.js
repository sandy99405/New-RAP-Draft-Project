...
sap.ui.define(["open/ux/preview/client/thirdparty/@sap-ux-private/control-property-editor-common", "sap/ui/dt/OverlayRegistry", "sap/ui/rta/command/CommandFactory", "../../../utils/application", "../../../utils/fe-v4", "../../../utils/version", "../../api-handler", "../../dialog-factory", "../dialog-enablement-validator", "../fe-v2/utils", "../quick-action-base"], function (___sap_ux_private_control_property_editor_common, OverlayRegistry, CommandFactory, _____utils_applicationjs, _____utils_fe_v4js, _____utils_versionjs, ____api_handlerjs, ____dialog_factoryjs, ___dialog_enablement_validatorjs, ___fe_v2_utilsjs, ___quick_action_basejs) {
  "use strict";

  const NESTED_QUICK_ACTION_KIND = ___sap_ux_private_control_property_editor_common["NESTED_QUICK_ACTION_KIND"];
  const getApplicationType = _____utils_applicationjs["getApplicationType"];
  ...
  const getDataSourceAnnotationFileMap = ____api_handlerjs["getDataSourceAnnotationFileMap"];
  ...
  const getV2AppComponent = ___fe_v2_utilsjs["getV2AppComponent"];
