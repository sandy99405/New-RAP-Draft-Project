...
sap.ui.define(["sap/ui/dt/OverlayRegistry", "../../../utils/core", "../../dialog-factory", "../control-types", "../table-quick-action-base", "../dialog-enablement-validator", "open/ux/preview/client/thirdparty/@sap-ux-private/control-property-editor-common", "../../../utils/info-center-message"], function (OverlayRegistry, _____utils_corejs, ____dialog_factoryjs, ___control_typesjs, ___table_quick_action_basejs, ___dialog_enablement_validatorjs, ___sap_ux_private_control_property_editor_common, _____utils_info_center_messagejs) {
  "use strict";
  ...
  const sendInfoCenterMessage = _____utils_info_center_messagejs["sendInfoCenterMessage"];
