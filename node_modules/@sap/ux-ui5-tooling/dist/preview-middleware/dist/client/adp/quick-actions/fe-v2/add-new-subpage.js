...
sap.ui.define(["../../../utils/fe-v2", "../add-new-subpage-quick-action-base", "../../../utils/core", "./utils"], function (_____utils_fe_v2js, ___add_new_subpage_quick_action_basejs, _____utils_corejs, ___utilsjs) {
  "use strict";

  const getV2ApplicationPages = _____utils_fe_v2js["getV2ApplicationPages"];
  const AddNewSubpageBase = ___add_new_subpage_quick_action_basejs["AddNewSubpageBase"];
  const isA = _____utils_corejs["isA"];
  const areManifestChangesSupported = ___utilsjs["areManifestChangesSupported"];
  const getV2AppComponent = ___utilsjs["getV2AppComponent"];
