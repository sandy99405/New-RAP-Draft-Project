...
sap.ui.define(["sap/ui/rta/util/hasStableId", "sap/ui/fl/Utils", "./dialog-factory", "../i18n", "./utils", "./sync-views-utils"], function (hasStableId, FlUtils, ___dialog_factoryjs, ___i18njs, ___utilsjs, ___sync_views_utilsjs) {
  "use strict";
  ...
  const getReuseComponentChecker = ___utilsjs["getReuseComponentChecker"];
  const getSyncViewIds = ___sync_views_utilsjs["getSyncViewIds"];
  /**
