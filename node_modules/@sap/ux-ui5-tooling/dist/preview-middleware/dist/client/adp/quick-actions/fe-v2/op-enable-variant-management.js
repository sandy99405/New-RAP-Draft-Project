...
sap.ui.define(["../table-quick-action-base", "../control-types", "./utils", "./create-table-custom-column"], function (___table_quick_action_basejs, ___control_typesjs, ___utilsjs, ___create_table_custom_columnjs) {
  "use strict";
