...
sap.ui.define(["sap/ui/dt/OverlayUtil", "../../../utils/core", "../table-quick-action-base", "../control-types", "../../../cpe/quick-actions/utils", "../fe-v2/create-table-custom-column", "../dialog-enablement-validator"], function (OverlayUtil, _____utils_corejs, ___table_quick_action_basejs, ___control_typesjs, _____cpe_quick_actions_utilsjs, ___fe_v2_create_table_custom_columnjs, ___dialog_enablement_validatorjs) {
  "use strict";

  const getControlById = _____utils_corejs["getControlById"];
  const findNestedElements = _____utils_corejs["findNestedElements"];
  const TableQuickActionDefinitionBase = ___table_quick_action_basejs["TableQuickActionDefinitionBase"];
  const MDC_ACTION_TOOLBAR_TYPE = ___control_typesjs["MDC_ACTION_TOOLBAR_TYPE"];
