...
export type MockDataContributor<T extends object> = {
    ...
    throwError?(message: string, statusCode?: number, messageData?: object, isSAPMessage?: boolean, headers?: Record<string, string>, isGlobalRequestError?: boolean): any;
...
export declare class FunctionBasedMockData extends FileBasedMockData {
    ...
    hasEntry(keyValues: KeyDefinitions, odataRequest: ODataRequest): boolean;
    hasEntries(odataRequest: ODataRequest): boolean;
    getEmptyObject(odataRequest: ODataRequest, allowEmptyKeys?: boolean): object;
    getDefaultElement(odataRequest: ODataRequest): object;
    generateKey(property: Property, lineIndex: number, odataRequest: ODataRequest): any;
    getAllEntries(odataRequest: ODataRequest, dontClone?: boolean): Promise<object[]>;
    onBeforeAction(actionDefinition: Action, actionData: any, keys: Record<string, any>, odataRequest: ODataRequest): Promise<object>;
    onAfterRead(data: object | object[], odataRequest: ODataRequest): Promise<object | object[]>;
    executeAction(actionDefinition: Action, actionData: any, keys: Record<string, any>, odataRequest: ODataRequest): Promise<object | undefined>;
    onAfterAction(actionDefinition: Action, actionData: any, keys: Record<string, any>, responseData: any, odataRequest: ODataRequest): Promise<any>;
    onDraftPrepare(actionDefinition: Action, responseData: any, keys: Record<string, any>, odataRequest: ODataRequest): Promise<void>;
    ...
    onAfterAddEntry(keyValues: KeyDefinitions, data: any, odataRequest: ODataRequest): Promise<void>;
    onBeforeAddEntry(keyValues: KeyDefinitions, data: any, odataRequest: ODataRequest): Promise<void>;
    hasCustomAggregate(customAggregateName: string, odataRequest: ODataRequest): boolean;
    performCustomAggregate(customAggregateName: string, dataToAggregate: any[], odataRequest: ODataRequest): any;
