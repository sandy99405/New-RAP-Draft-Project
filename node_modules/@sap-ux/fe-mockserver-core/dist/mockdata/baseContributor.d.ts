...
export declare class MockDataContributorClass<T extends object> {
    base: MockDataContributorBase<T>;
    constructor(base: MockDataContributorBase<T>);
    ...
    throwError(message: string, statusCode?: number, messageData?: object, isSAPMessage?: boolean, headers?: Record<string, string>, isGlobalRequestError?: boolean): void;
}
export declare class MockEntityContainerContributorClass {
    base: MockEntityContainerBase;
    constructor(base: MockEntityContainerBase);
    ...
    throwError(message: string, statusCode?: number, messageData?: object, isSAPMessage?: boolean): void;
}
//# sourceMappingURL=baseContributor.d.ts.map