...
} & AnnotationTerm<HeaderInfoTypeTypes>;
export type HeaderInfoType = ComplexType & {
    ...
    */
    Title?: DataFieldAbstractTypes;
    /**
        Description, e.g. for overview pages
    */
    Description?: DataFieldAbstractTypes;
    /**
...
export type Identification = {
    term: UIAnnotationTerms.Identification;
} & AnnotationTerm<DataFieldAbstractTypes[]>;
/**
  Information usually displayed in the form of a business card
*/
export type Badge = {
    term: UIAnnotationTerms.Badge;
} & AnnotationTerm<BadgeTypeTypes>;
export type BadgeType = ComplexType & {
    $Type: UIAnnotationTypes.BadgeType;
    /**
        Headline
    */
    HeadLine: DataFieldTypes;
    /**
        Title
    */
    Title: DataFieldTypes;
    /**
        Image URL for an instance of the entity type. If the property has a valid value, it can be used for the visualization of the instance. If it is not available or not valid the value of the property `TypeImageUrl` can be used instead.
    */
    ImageUrl?: Edm.String;
    ...
    */
    MainInfo?: DataFieldTypes;
    /**
        Additional information on the business card
    */
    SecondaryInfo?: DataFieldTypes;
};
/**
...
/**
  Defines the card structure for a list visualization. Use instead of UI.LineItem when presenting entity data as cards e.g. in a grid list layout.
*/
export type CardItem = {
    term: UIAnnotationTerms.CardItem;
} & AnnotationTerm<CardItemTypeTypes>;
/**
  Card structure for Grid List visualization. Header is always required. Details holds the card body as a collection of facets. Actions are optional card-level interactions.
*/
export type CardItemType = ComplexType & {
    $Type: UIAnnotationTypes.CardItemType;
    /**
        Points to a UI.HeaderInfo annotation defining the card header.
    */
    Header: Edm.AnnotationPath<HeaderInfo>;
    /**
        Action items for the card. Supports DataFieldForAction, DataFieldForIntentBasedNavigation, and DataFieldForActionGroup.
    */
    Actions?: DataFieldAbstractTypes[];
    /**
        Card body content as a collection of facets defining the sections of the card body.
    */
    Details: FacetTypes[];
};
/**
...
export type StatusInfo = {
    term: UIAnnotationTerms.StatusInfo;
} & AnnotationTerm<DataFieldAbstractTypes[]>;
/**
...
} & AnnotationTerm<FieldGroupTypeTypes>;
export type FieldGroupType = ComplexType & {
    ...
    */
    Data: DataFieldAbstractTypes[];
};
/**
  Group of semantically connected fields with a representation template and an optional label
*/
export type ConnectedFields = {
    term: UIAnnotationTerms.ConnectedFields;
} & AnnotationTerm<ConnectedFieldsTypeTypes>;
/**
  Group of semantically connected fields with a representation template and an optional label
*/
...
export type GeoLocations = {
    term: UIAnnotationTerms.GeoLocations;
} & AnnotationTerm<GeoLocationTypeTypes[]>;
/**
  Geographic location
*/
export type GeoLocation = {
    term: UIAnnotationTerms.GeoLocation;
} & AnnotationTerm<GeoLocationTypeTypes>;
/**
...
export type Contacts = {
    term: UIAnnotationTerms.Contacts;
} & AnnotationTerm<Edm.AnnotationPath<any>[]>;
/**
  Properties that describe a media resource
*/
export type MediaResource = {
    term: UIAnnotationTerms.MediaResource;
} & AnnotationTerm<MediaResourceTypeTypes>;
...
export type DataPoint = {
    term: UIAnnotationTerms.DataPoint;
} & AnnotationTerm<DataPointTypeTypes>;
export type DataPointType = ComplexType & {
    ...
    */
    CriticalityCalculation?: CriticalityCalculationTypeTypes;
    /**
    ...
    */
    TrendCalculation?: TrendCalculationTypeTypes;
    /**
        Contact person
    */
...
export declare const enum VisualizationTypeValues {
    /**
    Visualize as a number
    */
    /**
...
export declare const enum CriticalityTypeValues {
    /**
    Very negative / dark-red status - risk - out of stock - late
    */
    /**
...
*/
export type CriticalityCalculationType = ComplexType & Omit<CriticalityThresholdsType, '$Type'> & {
    ...
    */
    ConstantThresholds: LevelThresholdsTypeTypes[];
};
/**
...
export declare const enum ImprovementDirectionTypeValues {
    /**
    Lower is better
    */
    /**
...
*/
export type LevelThresholdsType = ComplexType & Omit<CriticalityThresholdsType, '$Type'> & {
    ...
    */
    AggregationLevel: Edm.PropertyPath[];
};
/**
...
export declare const enum TrendTypeValues {
    /**
    Value grows strongly
    */
    /**
...
*/
export type KPI = {
    term: UIAnnotationTerms.KPI;
} & AnnotationTerm<KPITypeTypes>;
...
export type KPIDetailType = ComplexType & {
    ...
    */
    DefaultPresentationVariant?: PresentationVariantTypeTypes;
    /**
        A list of alternative presentation variants, either specified inline or referencing another annotation via Path
    */
    AlternativePresentationVariants: PresentationVariantTypeTypes[];
    /**
...
*/
export type Chart = {
    term: UIAnnotationTerms.Chart;
} & AnnotationTerm<ChartDefinitionTypeTypes>;
...
export declare const enum ChartTypeValues {
    Column = 0,
    ColumnStacked = 1,
    ColumnDual = 2,
    ColumnStackedDual = 3,
...
export type ChartAxisScalingType = ComplexType & {
    ...
    */
    AutoScaleBehavior?: ChartAxisAutoScaleBehaviorTypeTypes;
    /**
        Boundary values for fixed scaling of a stacking chart type with multiple measures
    */
    FixedScaleMultipleStackedMeasuresBoundaryValues?: FixedScaleMultipleStackedMeasuresBoundaryValuesTypeTypes;
};
...
export declare const enum ChartAxisScaleBehaviorTypeValues {
    /**
    Value axes scale automatically
    */
    /**
...
export declare const enum ChartAxisAutoScaleDataScopeTypeValues {
    /**
    Minimum and maximum axes values are determined from the entire data set
    */
    /**
...
export type ChartDimensionAttributeType = ComplexType & {
    ...
    */
    ValuesForSequentialColorLevels: Edm.String[];
    /**
        All values in this collection should be emphasized.
    */
    EmphasizedValues: Edm.String[];
    /**
    ...
    */
    EmphasisLabels?: EmphasisLabelTypeTypes;
};
/**
...
export type ChartMeasureAttributeType = ComplexType & {
    ...
    */
    DynamicMeasure?: Edm.AnnotationPath<Analytics.AggregatedProperty | Aggregation.CustomAggregate>;
    ...
    */
    DataPoint?: Edm.AnnotationPath<DataPoint>;
    /**
...
export declare const enum ChartDimensionRoleTypeValues {
    Category = 0,
    Series = 1,
    Category2 = 2
}
...
export declare const enum ChartMeasureRoleTypeValues {
    Axis1 = 0,
    Axis2 = 1,
    Axis3 = 2
}
...
*/
export type ValueCriticality = {
    term: UIAnnotationTerms.ValueCriticality;
} & AnnotationTerm<ValueCriticalityTypeTypes[]>;
/**
...
*/
export type CriticalityLabels = {
    term: UIAnnotationTerms.CriticalityLabels;
} & AnnotationTerm<CriticalityLabelTypeTypes[]>;
/**
...
} & AnnotationTerm<FacetTypes[]>;
/**
  Facets for additional object header information
*/
export type HeaderFacets = {
    term: UIAnnotationTerms.HeaderFacets;
} & AnnotationTerm<FacetTypes[]>;
/**
  Facets that may be used for a quick overview of the object
*/
export type QuickViewFacets = {
    term: UIAnnotationTerms.QuickViewFacets;
} & AnnotationTerm<FacetTypes[]>;
/**
  Facets that may be used for a (quick) create of the object
*/
export type QuickCreateFacets = {
    term: UIAnnotationTerms.QuickCreateFacets;
} & AnnotationTerm<FacetTypes[]>;
/**
  Facets that reference UI.FieldGroup annotations to group filterable fields
*/
export type FilterFacets = {
    term: UIAnnotationTerms.FilterFacets;
} & AnnotationTerm<ReferenceFacetTypes[]>;
/**
  Facets that reference UI.FieldGroup annotations to group action or function parameters
*/
export type OperationParameterFacets = {
    term: UIAnnotationTerms.OperationParameterFacets;
} & AnnotationTerm<ReferenceFacetTypes[]>;
/**
...
/**
  Collection of facets
*/
export type CollectionFacet = ComplexType & Omit<Facet, '$Type'> & {
...
*/
export type ReferenceFacet = ComplexType & Omit<Facet, '$Type'> & {
    ...
    */
    Target: Edm.AnnotationPath<Communication.Address | Communication.Contact | Badge | CardItem | Chart | Contacts | DataPoint | FieldGroup | GeoLocation | GeoLocations | HeaderInfo | Identification | KPI | LineItem | MediaResource | Note | PresentationVariant | SelectionFields | SelectionPresentationVariant | StatusInfo>;
};
/**
  Facet that refers to a URL
*/
export type ReferenceURLFacet = ComplexType & Omit<Facet, '$Type'> & {
...
*/
export type SelectionPresentationVariant = {
    term: UIAnnotationTerms.SelectionPresentationVariant;
} & AnnotationTerm<SelectionPresentationVariantTypeTypes>;
export type SelectionPresentationVariantType = ComplexType & {
    ...
    */
    ...
    /**
        Presentation variant, either specified inline or referencing another annotation via Path
    */
    PresentationVariant: PresentationVariantTypeTypes;
};
/**
...
export type PresentationVariant = {
    term: UIAnnotationTerms.PresentationVariant;
} & AnnotationTerm<PresentationVariantTypeTypes>;
export type PresentationVariantType = ComplexType & {
    ...
    */
    DynamicTotal: Edm.AnnotationPath<Analytics.AggregatedProperty | Aggregation.CustomAggregate>[];
    /**
    ...
    */
    ...
    /**
        Lists available visualization types. Currently supported types are `UI.LineItem`, `UI.CardItem`, `UI.Chart`, and `UI.DataPoint`.
    ...
    */
    Visualizations: Edm.AnnotationPath<Chart | DataPoint | LineItem | CardItem>[];
    /**
    ...
    */
    RequestAtLeast: Edm.PropertyPath[];
    /**
    ...
    */
    SelectionFields: Edm.PropertyPath[];
};
/**
...
export type SelectionVariant = {
    term: UIAnnotationTerms.SelectionVariant;
} & AnnotationTerm<SelectionVariantTypeTypes>;
export type SelectionVariantType = ComplexType & {
    ...
    */
    Parameters: ParameterAbstractTypes[];
    /**
    ...
    */
    SelectOptions: SelectOptionTypeTypes[];
};
/**
...
*/
export type Parameter = ComplexType & Omit<ParameterAbstract, '$Type'> & {
...
*/
export type IntervalParameter = ComplexType & Omit<ParameterAbstract, '$Type'> & {
...
export type SelectOptionType = ComplexType & {
    ...
    */
    DynamicPropertyName?: Edm.AnnotationPath<Analytics.AggregatedProperty | Aggregation.CustomAggregate>;
    /**
...
export declare const enum SelectionRangeSignTypeValues {
    /**
    Inclusive
    */
    /**
...
export declare const enum SelectionRangeOptionTypeValues {
    /**
    Equal to
    */
    /**
...
*/
export type ThingPerspective = {
    term: UIAnnotationTerms.ThingPerspective;
...
*/
export type IsImage = {
    term: UIAnnotationTerms.IsImage;
} & AnnotationTerm<Core.Tag, {
    Common?: {
        [key: string]: any;
    } & {
...
export type MultiLineText = {
    term: UIAnnotationTerms.MultiLineText;
} & AnnotationTerm<Core.Tag>;
/**
  A short, human-readable text that gives a hint or an example to help the user with data entry
*/
export type Placeholder = {
    term: UIAnnotationTerms.Placeholder;
} & AnnotationTerm<Edm.String>;
/**
  Properties or parameters annotated with this term will get a mask in edit mode
*/
export type InputMask = {
    term: UIAnnotationTerms.InputMask;
} & AnnotationTerm<InputMaskTypeTypes>;
export type InputMaskType = ComplexType & {
    $Type: UIAnnotationTypes.InputMaskType;
    /**
        The mask to be applied to the property or the parameter
    */
    Mask: Edm.String;
    /**
    ...
    */
    ...
    /**
        Rules that define valid values for one symbol in the mask
    */
    Rules: InputMaskRuleTypeTypes[];
};
export type InputMaskRuleType = ComplexType & {
    $Type: UIAnnotationTypes.InputMaskRuleType;
    /**
    ...
    */
    ...
    /**
        Regular expression that defines the valid values for the mask symbol
    */
    RegExp: Edm.String;
};
/**
...
*/
export type TextArrangement = TextArrangementType | TextArrangementTypeValues;
...
export declare const enum TextArrangementTypeValues {
    /**
    Text is first, followed by the code/ID (e.g. in parentheses)
    */
    /**
...
export type DateTimeStyle = {
    term: UIAnnotationTerms.DateTimeStyle;
} & AnnotationTerm<Edm.String>;
/**
  Visualization of a note attached to an entity
*/
export type Note = {
    term: UIAnnotationTerms.Note;
} & AnnotationTerm<NoteTypeTypes>;
export type NoteType = ComplexType & {
    $Type: UIAnnotationTypes.NoteType;
    /**
        Title of the note
    */
    Title?: Edm.String;
    ...
    */
    Content: Edm.String;
    /**
        A type used for grouping notes
    */
    Type: Edm.String;
    /**
        Type-specific maximal length of the content of the note
    */
    MaximalLength?: Edm.Int32;
    /**
        Whether the type allows multiple notes for one object
    */
...
*/
export type Importance = ImportanceType | ImportanceTypeValues;
...
export declare const enum ImportanceTypeValues {
    /**
    High importance
    */
    /**
...
*/
export type DataFieldDefault = {
    term: UIAnnotationTerms.DataFieldDefault;
} & AnnotationTerm<DataFieldAbstractTypes>;
/**
...
export declare const enum CriticalityRepresentationTypeValues {
    /**
    Criticality is represented with an icon
    */
    /**
...
*/
export type DataFieldForAnnotation = ComplexType & Omit<DataFieldAbstract, '$Type'> & {
    ...
    */
    Target: Edm.AnnotationPath<Communication.Address | Communication.Contact | Chart | ConnectedFields | DataPoint | FieldGroup | PresentationVariant | SelectionPresentationVariant>;
};
/**
  Triggers an action
*/
export type DataFieldForActionAbstract = ComplexType & Omit<DataFieldAbstract, '$Type'> & {
...
*/
export type DataFieldForAction = ComplexType & Omit<DataFieldForActionAbstract, '$Type'> & {
...
export declare const enum OperationGroupingTypeValues {
    /**
    Invoke each action in isolation from other actions
    */
    /**
...
*/
export type DataFieldForIntentBasedNavigation = ComplexType & Omit<DataFieldForActionAbstract, '$Type'> & {
...
*/
export type DataFieldForActionGroup = ComplexType & Omit<DataFieldAbstract, '$Type'> & {
    $Type: UIAnnotationTypes.DataFieldForActionGroup;
    /**
    ...
    */
    Actions: DataFieldForActionAbstractTypes[];
};
/**
  A piece of data
*/
export type DataField = ComplexType & Omit<DataFieldAbstract, '$Type'> & {
...
*/
export type DataFieldWithAction = ComplexType & Omit<DataField, '$Type'> & {
...
*/
export type DataFieldWithIntentBasedNavigation = ComplexType & Omit<DataField, '$Type'> & {
...
*/
export type DataFieldWithNavigationPath = ComplexType & Omit<DataField, '$Type'> & {
...
*/
export type DataFieldWithUrl = ComplexType & Omit<DataField, '$Type'> & {
...
/**
  Collection of OData actions and intent based navigations
*/
export type DataFieldWithActionGroup = ComplexType & Omit<DataField, '$Type'> & {
    $Type: UIAnnotationTypes.DataFieldWithActionGroup;
    Value: Edm.PrimitiveType;
    /**
...
export type RecommendationList = {
    term: UIAnnotationTerms.RecommendationList;
} & AnnotationTerm<RecommendationListTypeTypes>;
/**
...
export type RecommendationListType = ComplexType & {
    ...
    */
    Binding: RecommendationBindingTypes[];
};
...
export type Recommendations = {
    term: UIAnnotationTerms.Recommendations;
} & AnnotationTerm<Edm.Untyped>;
/**
  Base type containing recommendations for an entity type property
*/
export type PropertyRecommendationType = ComplexType & {
    $Type: UIAnnotationTypes.PropertyRecommendationType;
    /**
        Recommended value
    */
    ...
    */
    ...
    /**
        Confidence score of the recommended value
    */
    RecommendedFieldScoreValue?: Edm.Decimal;
    /**
        Whether the recommended value shall be suggested in the input field
    */
...
*/
export type ExcludeFromNavigationContext = {
    term: UIAnnotationTerms.ExcludeFromNavigationContext;
} & AnnotationTerm<Core.Tag>;
/**
  Do not check the number of fractional digits of the annotated measured quantity
*/
export type DoNotCheckScaleOfMeasuredQuantity = {
    term: UIAnnotationTerms.DoNotCheckScaleOfMeasuredQuantity;
} & AnnotationTerm<Edm.Boolean>;
/**
  The referenced entity set is the preferred starting point for UIs using this service
*/
export type LeadingEntitySet = {
    term: UIAnnotationTerms.LeadingEntitySet;
} & AnnotationTerm<Edm.String>;
/**
  Name of an Action, Function, ActionImport, or FunctionImport in scope
*/
export type ActionName = Edm.String;
export declare const enum UIAnnotationTerms {
    ...
    CardItem = "com.sap.vocabularies.UI.v1.CardItem",
    ...
    OperationParameterFacets = "com.sap.vocabularies.UI.v1.OperationParameterFacets",
    ...
    InputMask = "com.sap.vocabularies.UI.v1.InputMask",
    TextArrangement = "com.sap.vocabularies.UI.v1.TextArrangement",
    DateTimeStyle = "com.sap.vocabularies.UI.v1.DateTimeStyle",
    Note = "com.sap.vocabularies.UI.v1.Note",
    Importance = "com.sap.vocabularies.UI.v1.Importance",
    Hidden = "com.sap.vocabularies.UI.v1.Hidden",
    IsCopyAction = "com.sap.vocabularies.UI.v1.IsCopyAction",
    IsAIOperation = "com.sap.vocabularies.UI.v1.IsAIOperation",
    ...
    AdaptationHidden = "com.sap.vocabularies.UI.v1.AdaptationHidden",
    ...
    Emphasized = "com.sap.vocabularies.UI.v1.Emphasized",
    ...
    Recommendations = "com.sap.vocabularies.UI.v1.Recommendations",
    ExcludeFromNavigationContext = "com.sap.vocabularies.UI.v1.ExcludeFromNavigationContext",
    DoNotCheckScaleOfMeasuredQuantity = "com.sap.vocabularies.UI.v1.DoNotCheckScaleOfMeasuredQuantity",
    LeadingEntitySet = "com.sap.vocabularies.UI.v1.LeadingEntitySet"
}
export declare const enum UIAnnotationTypes {
    ...
    CardItemType = "com.sap.vocabularies.UI.v1.CardItemType",
    ...
    InputMaskType = "com.sap.vocabularies.UI.v1.InputMaskType",
    InputMaskRuleType = "com.sap.vocabularies.UI.v1.InputMaskRuleType",
    NoteType = "com.sap.vocabularies.UI.v1.NoteType",
    ...
    DataFieldForActionGroup = "com.sap.vocabularies.UI.v1.DataFieldForActionGroup",
    ...
    DataFieldWithActionGroup = "com.sap.vocabularies.UI.v1.DataFieldWithActionGroup",
    ...
    PropertyRecommendationType = "com.sap.vocabularies.UI.v1.PropertyRecommendationType"
}
export type HeaderInfoTypeTypes = HeaderInfoType;
export type BadgeTypeTypes = BadgeType;
export type CardItemTypeTypes = CardItemType;
export type FieldGroupTypeTypes = FieldGroupType;
export type ConnectedFieldsTypeTypes = ConnectedFieldsType;
export type GeoLocationTypeTypes = GeoLocationType;
export type MediaResourceTypeTypes = MediaResourceType;
export type ImageTypeTypes = ImageType;
export type DataPointTypeTypes = DataPointType;
export type NumberFormatTypes = NumberFormat;
export type ReferencePeriodTypes = ReferencePeriod;
export type CriticalityCalculationTypeTypes = CriticalityCalculationType;
export type CriticalityThresholdsTypeTypes = CriticalityThresholdsType | CriticalityCalculationTypeTypes | LevelThresholdsTypeTypes;
export type LevelThresholdsTypeTypes = LevelThresholdsType;
export type TrendCalculationTypeTypes = TrendCalculationType;
export type KPITypeTypes = KPIType;
export type KPIDetailTypeTypes = KPIDetailType;
export type ChartDefinitionTypeTypes = ChartDefinitionType;
export type ChartAxisScalingTypeTypes = ChartAxisScalingType;
export type ChartAxisAutoScaleBehaviorTypeTypes = ChartAxisAutoScaleBehaviorType;
export type FixedScaleMultipleStackedMeasuresBoundaryValuesTypeTypes = FixedScaleMultipleStackedMeasuresBoundaryValuesType;
export type ChartDimensionAttributeTypeTypes = ChartDimensionAttributeType;
export type ChartMeasureAttributeTypeTypes = ChartMeasureAttributeType;
export type EmphasisLabelTypeTypes = EmphasisLabelType;
export type ValueCriticalityTypeTypes = ValueCriticalityType;
export type CriticalityLabelTypeTypes = CriticalityLabelType;
export type FacetTypes = CollectionFacetTypes | ReferenceFacetTypes | ReferenceURLFacetTypes;
export type CollectionFacetTypes = CollectionFacet;
export type ReferenceFacetTypes = ReferenceFacet;
export type ReferenceURLFacetTypes = ReferenceURLFacet;
export type SelectionPresentationVariantTypeTypes = SelectionPresentationVariantType;
export type PresentationVariantTypeTypes = PresentationVariantType;
export type SelectionVariantTypeTypes = SelectionVariantType;
export type ParameterAbstractTypes = ParameterTypes | IntervalParameterTypes;
export type ParameterTypes = Parameter;
export type IntervalParameterTypes = IntervalParameter;
export type SelectOptionTypeTypes = SelectOptionType;
export type SelectionRangeTypeTypes = SelectionRangeType;
export type InputMaskTypeTypes = InputMaskType;
export type InputMaskRuleTypeTypes = InputMaskRuleType;
export type NoteTypeTypes = NoteType;
export type DataFieldAbstractTypes = DataFieldForAnnotationTypes | DataFieldForActionAbstractTypes | DataFieldForActionGroupTypes | DataFieldTypes;
export type DataFieldForAnnotationTypes = DataFieldForAnnotation;
export type DataFieldForActionAbstractTypes = DataFieldForActionTypes | DataFieldForIntentBasedNavigationTypes;
export type DataFieldForActionTypes = DataFieldForAction;
export type DataFieldForIntentBasedNavigationTypes = DataFieldForIntentBasedNavigation;
export type DataFieldForActionGroupTypes = DataFieldForActionGroup;
export type DataFieldTypes = DataField | DataFieldWithActionTypes | DataFieldWithIntentBasedNavigationTypes | DataFieldWithNavigationPathTypes | DataFieldWithUrlTypes | DataFieldWithActionGroupTypes;
export type DataFieldWithActionTypes = DataFieldWithAction;
export type DataFieldWithIntentBasedNavigationTypes = DataFieldWithIntentBasedNavigation;
export type DataFieldWithNavigationPathTypes = DataFieldWithNavigationPath;
export type DataFieldWithUrlTypes = DataFieldWithUrl;
export type DataFieldWithActionGroupTypes = DataFieldWithActionGroup;
export type RecommendationListTypeTypes = RecommendationListType;
export type RecommendationBindingTypes = RecommendationBinding;
