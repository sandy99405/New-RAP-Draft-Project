...
export type DocumentationRef = {
    term: CommonAnnotationTerms.DocumentationRef;
} & AnnotationTerm<Edm.String>;
/**
...
export type Text = {
    ...
    UI?: {
        ...
        'TextArrangement': UI.TextArrangement;
    };
}>;
/**
...
/**
  The listed properties form a secondary key
*/
...
} & AnnotationTerm<SemanticObjectMappingAbstractTypes[]>;
/**
...
*/
export type SemanticObjectMappingAbstract = ComplexType & {
    $Type: CommonAnnotationTypes.SemanticObjectMappingAbstract;
    /**
        Name of the Semantic Object property
    */
    SemanticObjectProperty: Edm.String;
};
export type SemanticObjectMappingType = ComplexType & Omit<SemanticObjectMappingAbstract, '$Type'> & {
...
export type SemanticObjectMappingConstant = ComplexType & Omit<SemanticObjectMappingAbstract, '$Type'> & {
    $Type: CommonAnnotationTypes.SemanticObjectMappingConstant;
    /**
        Constant value for the Semantic Object property
    */
...
export type OperationTemplate = {
    term: CommonAnnotationTerms.OperationTemplate;
...
export type SideEffectsType = ComplexType & {
    ...
    */
    ...
    /**
        Creating one or more of these entities may affect the targets.
    */
    SourceEntitiesInserted: Edm.NavigationPropertyPath[];
    /**
        Updating one or more of these entities may affect the targets.
    */
    SourceEntitiesUpdated: Edm.NavigationPropertyPath[];
    /**
        Deleting one or more of these entities may affect the targets.
    */
    SourceEntitiesDeleted: Edm.NavigationPropertyPath[];
    /**
        When the service raises one or more of these "events for side effects", the targets may be affected
    */
    SourceEvents: Edm.String[];
    /**
...
export type WebSocketChannel = {
    term: CommonAnnotationTerms.WebSocketChannel;
} & AnnotationTerm<Edm.String>;
/**
  Service prefers requests to use a resource path with navigation properties
*/
export type AddressViaNavigationPath = {
    term: CommonAnnotationTerms.AddressViaNavigationPath;
} & AnnotationTerm<Core.Tag>;
/**
...
export type ReferentialConstraint = {
    term: CommonAnnotationTerms.ReferentialConstraint;
} & AnnotationTerm<ReferentialConstraintTypeTypes[]>;
/**
...
*/
export type ReferentialConstraintType = ComplexType & {
    $Type: CommonAnnotationTypes.ReferentialConstraintType;
    /**
...
export declare const enum CommonAnnotationTerms {
    ...
    OperationTemplate = "com.sap.vocabularies.Common.v1.OperationTemplate",
    ...
    WebSocketChannel = "com.sap.vocabularies.Common.v1.WebSocketChannel",
    AddressViaNavigationPath = "com.sap.vocabularies.Common.v1.AddressViaNavigationPath",
    ReferentialConstraint = "com.sap.vocabularies.Common.v1.ReferentialConstraint"
}
export declare const enum CommonAnnotationTypes {
    SemanticObjectMappingAbstract = "com.sap.vocabularies.Common.v1.SemanticObjectMappingAbstract",
    SemanticObjectMappingType = "com.sap.vocabularies.Common.v1.SemanticObjectMappingType",
    SemanticObjectMappingConstant = "com.sap.vocabularies.Common.v1.SemanticObjectMappingConstant",
    ...
    ReferentialConstraintType = "com.sap.vocabularies.Common.v1.ReferentialConstraintType"
}
export type SemanticObjectMappingAbstractTypes = SemanticObjectMappingTypeTypes | SemanticObjectMappingConstantTypes;
export type SemanticObjectMappingTypeTypes = SemanticObjectMappingType;
export type SemanticObjectMappingConstantTypes = SemanticObjectMappingConstant;
...
export type ReferentialConstraintTypeTypes = ReferentialConstraintType;
