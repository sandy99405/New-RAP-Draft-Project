...
/**
  Service supports $batch requests and the `continue-on-error` preference
*/
...
export type ChangeTrackingBase = ComplexType & {
    $Type: CapabilitiesAnnotationTypes.ChangeTrackingBase;
    /**
        odata.track-changes preference is supported
    */
    Supported: Edm.Boolean;
};
export type ChangeTrackingType = ComplexType & Omit<ChangeTrackingBase, '$Type'> & {
...
export type CountRestrictionsBase = ComplexType & {
    $Type: CapabilitiesAnnotationTypes.CountRestrictionsBase;
    /**
        Instances can be counted in requests targeting a collection
    */
    Countable: Edm.Boolean;
};
export type CountRestrictionsType = ComplexType & Omit<CountRestrictionsBase, '$Type'> & {
...
export type FilterRestrictionsBase = ComplexType & {
    $Type: CapabilitiesAnnotationTypes.FilterRestrictionsBase;
    /**
        $filter is supported
    */
    Filterable: Edm.Boolean;
...
export type FilterRestrictionsType = ComplexType & Omit<FilterRestrictionsBase, '$Type'> & {
...
export type SortRestrictionsBase = ComplexType & {
    $Type: CapabilitiesAnnotationTypes.SortRestrictionsBase;
    /**
        $orderby is supported
    */
    Sortable: Edm.Boolean;
};
export type SortRestrictionsType = ComplexType & Omit<SortRestrictionsBase, '$Type'> & {
...
export type ExpandRestrictionsBase = ComplexType & {
    $Type: CapabilitiesAnnotationTypes.ExpandRestrictionsBase;
    /**
        $expand is supported
    */
    Expandable: Edm.Boolean;
...
export type ExpandCollectionRestrictionsType = ComplexType & Omit<ExpandRestrictionsBase, '$Type'> & {
    $Type: CapabilitiesAnnotationTypes.ExpandCollectionRestrictionsType;
    /**
        Restrictions on expand expressions when accessed by key
    */
    ExpandByKeyRestrictions?: ExpandByKeyRestrictionsBaseTypes;
};
export type ExpandRestrictionsType = ComplexType & Omit<ExpandCollectionRestrictionsType, '$Type'> & {
...
export type ExpandByKeyRestrictionsBase = ComplexType & Omit<ExpandRestrictionsBase, '$Type'> & {
    $Type: CapabilitiesAnnotationTypes.ExpandByKeyRestrictionsBase;
};
export type ExpandByKeyRestrictionsType = ComplexType & Omit<ExpandByKeyRestrictionsBase, '$Type'> & {
    $Type: CapabilitiesAnnotationTypes.ExpandByKeyRestrictionsType;
    /**
...
export type InsertRestrictionsBase = ComplexType & {
    $Type: CapabilitiesAnnotationTypes.InsertRestrictionsBase;
    /**
...
export type InsertRestrictionsType = ComplexType & Omit<InsertRestrictionsBase, '$Type'> & {
...
export type UpdateRestrictionsBase = ComplexType & {
    $Type: CapabilitiesAnnotationTypes.UpdateRestrictionsBase;
    /**
...
export type UpdateRestrictionsType = ComplexType & Omit<UpdateRestrictionsBase, '$Type'> & {
...
export type DeleteRestrictionsBase = ComplexType & {
    $Type: CapabilitiesAnnotationTypes.DeleteRestrictionsBase;
    /**
...
export type DeleteRestrictionsType = ComplexType & Omit<DeleteRestrictionsBase, '$Type'> & {
...
export type DefaultCapabilities = {
    term: CapabilitiesAnnotationTerms.DefaultCapabilities;
} & AnnotationTerm<DefaultCapabilitiesTypeTypes>;
export type DefaultCapabilitiesType = ComplexType & {
    $Type: CapabilitiesAnnotationTypes.DefaultCapabilitiesType;
    /**
        Change tracking capabilities
    */
    ChangeTracking?: ChangeTrackingBaseTypes;
    /**
        Restrictions on /$count path suffix and $count=true system query option
    */
    CountRestrictions?: CountRestrictionsBaseTypes;
    /**
        Supports key values according to OData URL conventions
    */
    ...
    */
    ...
    /**
        Restrictions on filter expressions
    */
    FilterRestrictions?: FilterRestrictionsBaseTypes;
    /**
        Restrictions on orderby expressions
    */
    SortRestrictions?: SortRestrictionsBaseTypes;
    /**
        Restrictions on expand expressions
    */
    ExpandRestrictions?: ExpandRestrictionsBaseTypes;
    /**
        Restrictions on search expressions
    */
    SearchRestrictions?: SearchRestrictionsTypeTypes;
    /**
        Restrictions on insert operations
    */
    InsertRestrictions?: InsertRestrictionsBaseTypes;
    /**
        Restrictions on update operations
    */
    UpdateRestrictions?: UpdateRestrictionsBaseTypes;
    /**
        Restrictions on delete operations
    */
    DeleteRestrictions?: DeleteRestrictionsBaseTypes;
    /**
        Restrictions for function or action operations
    */
    OperationRestrictions?: OperationRestrictionsTypeTypes;
    /**
        Restrictions for retrieving a collection of entities, retrieving a singleton instance
    */
    ReadRestrictions?: ReadRestrictionsTypeTypes;
...
export declare const enum CapabilitiesAnnotationTerms {
    ...
    DefaultCapabilities = "Org.OData.Capabilities.V1.DefaultCapabilities"
}
export declare const enum CapabilitiesAnnotationTypes {
    ...
    ChangeTrackingBase = "Org.OData.Capabilities.V1.ChangeTrackingBase",
    ChangeTrackingType = "Org.OData.Capabilities.V1.ChangeTrackingType",
    CountRestrictionsBase = "Org.OData.Capabilities.V1.CountRestrictionsBase",
    ...
    FilterRestrictionsBase = "Org.OData.Capabilities.V1.FilterRestrictionsBase",
    ...
    SortRestrictionsBase = "Org.OData.Capabilities.V1.SortRestrictionsBase",
    SortRestrictionsType = "Org.OData.Capabilities.V1.SortRestrictionsType",
    ExpandRestrictionsBase = "Org.OData.Capabilities.V1.ExpandRestrictionsBase",
    ExpandCollectionRestrictionsType = "Org.OData.Capabilities.V1.ExpandCollectionRestrictionsType",
    ExpandRestrictionsType = "Org.OData.Capabilities.V1.ExpandRestrictionsType",
    ExpandByKeyRestrictionsBase = "Org.OData.Capabilities.V1.ExpandByKeyRestrictionsBase",
    ExpandByKeyRestrictionsType = "Org.OData.Capabilities.V1.ExpandByKeyRestrictionsType",
    SearchRestrictionsType = "Org.OData.Capabilities.V1.SearchRestrictionsType",
    InsertRestrictionsBase = "Org.OData.Capabilities.V1.InsertRestrictionsBase",
    ...
    UpdateRestrictionsBase = "Org.OData.Capabilities.V1.UpdateRestrictionsBase",
    ...
    DeleteRestrictionsBase = "Org.OData.Capabilities.V1.DeleteRestrictionsBase",
    ...
    DefaultCapabilitiesType = "Org.OData.Capabilities.V1.DefaultCapabilitiesType",
...
export type ChangeTrackingBaseTypes = ChangeTrackingBase | ChangeTrackingTypeTypes;
export type ChangeTrackingTypeTypes = ChangeTrackingType;
export type CountRestrictionsBaseTypes = CountRestrictionsBase | CountRestrictionsTypeTypes;
...
export type FilterRestrictionsBaseTypes = FilterRestrictionsBase | FilterRestrictionsTypeTypes;
...
export type SortRestrictionsBaseTypes = SortRestrictionsBase | SortRestrictionsTypeTypes;
export type SortRestrictionsTypeTypes = SortRestrictionsType;
export type ExpandRestrictionsBaseTypes = ExpandRestrictionsBase | ExpandCollectionRestrictionsTypeTypes | ExpandByKeyRestrictionsBaseTypes;
export type ExpandCollectionRestrictionsTypeTypes = ExpandCollectionRestrictionsType | ExpandRestrictionsTypeTypes;
export type ExpandRestrictionsTypeTypes = ExpandRestrictionsType;
export type ExpandByKeyRestrictionsBaseTypes = ExpandByKeyRestrictionsBase | ExpandByKeyRestrictionsTypeTypes;
export type ExpandByKeyRestrictionsTypeTypes = ExpandByKeyRestrictionsType;
export type SearchRestrictionsTypeTypes = SearchRestrictionsType;
export type InsertRestrictionsBaseTypes = InsertRestrictionsBase | InsertRestrictionsTypeTypes;
...
export type UpdateRestrictionsBaseTypes = UpdateRestrictionsBase | UpdateRestrictionsTypeTypes;
...
export type DeleteRestrictionsBaseTypes = DeleteRestrictionsBase | DeleteRestrictionsTypeTypes;
...
export type DefaultCapabilitiesTypeTypes = DefaultCapabilitiesType;
