...
*/
export type RelatedDataCategoryID = {
    term: PersonalDataAnnotationTerms.RelatedDataCategoryID;
} & AnnotationTerm<Edm.String[]>;
export declare const enum PersonalDataAnnotationTerms {
    ...
    RelatedDataCategoryID = "com.sap.vocabularies.PersonalData.v1.RelatedDataCategoryID"
}
