    ...
    return entityProperties.reduce((outObject, entityProperty) => {
        ...
        if (entityProperty._attributes.MaxLength) {
            edmProperty.maxLength =
                ((_b = (_a = entityProperty._attributes.MaxLength) === null || _a === void 0 ? void 0 : _a.toLowerCase) === null || _b === void 0 ? void 0 : _b.call(_a)) === 'max'
                    ? 5000
        ...
        if (entityProperty._attributes.Scale) {
            if (((_d = (_c = entityProperty._attributes.Scale) === null || _c === void 0 ? void 0 : _c.toLowerCase) === null || _d === void 0 ? void 0 : _d.call(_c)) === 'variable') {
...
function parseEnumTypes(enumTypes, annotationLists, namespace) {
    return enumTypes.reduce((outArray, enumType) => {
        ...
        outArray.push({
            ...
            underlyingType: (_a = enumType._attributes.UnderlyingType) !== null && _a !== void 0 ? _a : 'Edm.Int32',
            ...
            parameters: parameters.map((param) => {
                ...
                if (param._attributes.MaxLength) {
                    edmActionParameter.maxLength =
                        ((_b = (_a = param._attributes.MaxLength) === null || _a === void 0 ? void 0 : _a.toLowerCase) === null || _b === void 0 ? void 0 : _b.call(_a)) === 'max'
                            ? 5000
                ...
                if (param._attributes.Scale) {
                    if (((_d = (_c = param._attributes.Scale) === null || _c === void 0 ? void 0 : _c.toLowerCase) === null || _d === void 0 ? void 0 : _d.call(_c)) === 'variable') {
