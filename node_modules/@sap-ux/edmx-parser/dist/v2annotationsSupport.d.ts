...
export type ObjectType = 'EntitySet' | 'EntityType' | 'Singleton' | 'Property' | 'NavigationProperty' | 'ActionParameter';
/**
 ...
 */
export declare function convertV2Annotations(attributes: V2annotationsSupport, objectType: ObjectType, objectName: string): RawAnnotation[];
/**
 ...
 */
export declare function convertGenericAnnotations(attributes: V2annotationsSupport, objectName: string, annotations: RawAnnotation[]): void;
/**
 ...
 * @param annotations The raw annotation array
 */
export declare function convertEntitySetAnnotations(attributes: V2annotationsSupport, annotations: RawAnnotation[]): void;
/**
 ...
 * @param annotations The raw annotation array
 */
export declare function convertNavigationPropertyAnnotations(attributes: V2annotationsSupport, objectName: string, annotations: RawAnnotation[]): void;
/**
 ...
 * @param annotations The raw annotation array
 */
export declare function convertPropertyAnnotations(attributes: V2annotationsSupport, objectName: string, annotations: RawAnnotation[]): void;
/**
 * Convert annotations specific to properties.
 *
 * @param attributes The V2 Annotations to evaluate
 * @param annotations The raw annotation array
 */
export declare function convertEntityTypeAnnotations(attributes: V2annotationsSupport, annotations: RawAnnotation[]): void;
//# sourceMappingURL=v2annotationsSupport.d.ts.map