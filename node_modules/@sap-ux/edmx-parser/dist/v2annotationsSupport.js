...
function convertGenericAnnotations(attributes, objectName, annotations) {
    ...
    pushToAnnotations(attributes['sap:display-format'] === 'Date', {
        term: "com.sap.vocabularies.Common.v1.IsCalendarDate" /* CommonAnnotationTerms.IsCalendarDate */,
        value: {
            type: 'Bool',
            Bool: true
        }
