 ...
 */
import type { AnnotationList, RawAction, RawActionImport, RawAssociation, RawAssociationSet, RawComplexType, RawEntityContainer, RawEntitySet, RawEntityType, RawEnumType, RawMetadata, RawSchema, RawSingleton, RawTypeDefinition, Reference } from '@sap-ux/vocabularies-types';
/**
