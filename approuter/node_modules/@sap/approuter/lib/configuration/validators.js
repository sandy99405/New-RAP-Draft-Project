...
const sessionContextInputSchema = require('./schemas/session-context-input-schema.json');
...
module.exports = {
  ...
  validateSessionContextInput: function (sessionContextInput) {
    const validator = new JsonValidator();
    validator.validate(sessionContextInput, sessionContextInputSchema, 'session context input');
  },
